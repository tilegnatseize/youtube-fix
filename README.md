...
**[tilegnatseize/youtube-fix](https://github.com/tilegnatseize/youtube-fix)** — сборка для Windows 10/11

[**⬇ Скачать последний релиз**](https://github.com/tilegnatseize/youtube-fix/releases/latest)
...
> Если вы наткнулись на что-то вне репозитория `tilegnatseize/youtube-fix`, что распространяется от моего лица — **ФЕЙК**.
...
1. Откройте [**Releases → Latest**](https://github.com/tilegnatseize/youtube-fix/releases/latest) и скачайте **`.rar`** (предпочтительно)
